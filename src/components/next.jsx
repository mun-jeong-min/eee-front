  ...
  return (
    <div className='App'>
      ...
      <div className='nextBorder'>
        <Link to='/search'>
          <img className='mainImg' src={search} alt='서칭' />
        </Link>
        <Link to='/question'>
          <img className='mainImg' src={question} alt='문의' />
        </Link>
        <Link to='/alarm'>
          <img className='mainImg' src={alarm} alt='알람' />
        </Link>
        <Link to='/add'>
          <img className='mainImg' src={add} alt='추가' />
        </Link>
      </div>
    </div>
  );
